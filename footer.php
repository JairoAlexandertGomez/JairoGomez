...
?>
    	...
    	<?php
    		$customizer_styling_arr = array( 
    			array(
					'id'	=>	'demo99', 
					'title' => 'Classic', 
					'url' => 'http://themes.themegoods.com/grandportfolio/landing'
				),
				array(
					'id'	=>	'demo1', 
					'title' => 'Architect', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo1'
				),
				array(
					'id'	=>	'demo2', 
					'title' => 'Blogger', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo2'
				),
				array(
					'id'	=>	'demo3', 
					'title' => 'Creative & Design Agency', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo3'
				),
				array(
					'id'	=>	'demo4', 
					'title' => 'Fashion Designer', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo4'
				),
				array(
					'id'	=>	'demo5', 
					'title' => 'Music Band & Singer', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo5'
				),
				array(
					'id'	=>	'demo6', 
					'title' => 'Photographer', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo6'
				),
				array(
					'id'	=>	'demo7', 
					'title' => 'Magazine & Publisher', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo7'
				),
				array(
					'id'	=>	'demo8', 
					'title' => 'Agency Company', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo8'
				),
				array(
					'id'	=>	'demo9', 
					'title' => 'Creative Company', 
					'url' => 'http://themes.themegoods.com/grandportfolio/demo9'
				),
			);
    	?>
    	<ul class="demo_list">
    ...
    <div id="option_btn">
    	...
    	<a href="http://themes.themegoods.com/grandportfolio/doc" class="demotip" title="Theme Documentation" target="_blank"><i class="fa fa-book"></i></a>
