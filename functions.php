...
{ 
	...
	?>
		...
		<div class="header_wrap">
			...
			<h2><?php esc_html_e('Theme Setting', 'grandportfolio-translation' ); ?><span class="pp_version">v<?php echo THEMEVERSION; ?></span></h2>
			</div>
			<div style="float:right;margin:20px 0 0 0">
				<input id="save_ppsettings" name="save_ppsettings" class="button button-primary button-large" type="submit" value="<?php esc_html_e('Save', 'grandportfolio-translation' ); ?>" />
				<br/><br/>
	    ...
	    { 
	    	switch($_POST['demo'])
	    	{
		    	...
		    	default:
		    		...
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/landing';
		    	...
		    	case 1:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo1';
		    	...
		    	case 2:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo2';
		    	...
		    	case 3:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo3';
		    	...
		    	case 4:
		    		...
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo4';
		    	...
		    	case 5:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo5';
		    	...
		    	case 6:
		    		...
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo6';
		    	...
		    	case 7:
		    		...
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo7';
		    	...
		    	case 8:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo8';
		    	...
		    	case 9:
		    		...
		    		$import_filepath = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".xml" ;
		    		$styling_file = get_template_directory() ."/cache/demos/importer/demo".$_POST['demo']."/".$_POST['demo'].".dat" ;
		    		$oldurl = 'http://themes.themegoods.com/grandportfolio/demo9';
